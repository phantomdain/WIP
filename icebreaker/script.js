const questions = {
    ...
    tagalog: [
        ...
        "Paano mo itinuturing ang isang magandang buhay?",
        "Ano ang isang malaking pagbabago sa buhay mo?",
        "Kung ikaw ay magbibigay ng TED talk, ano ito?",
        "Ano ang pinagmamalaki mong trait sa iyong sarili?",
        "Ano ang isang bagay na gusto mong gawin mas madalas?",
        "Ano ang isang kamakailang karanasan na nagpasaya sa'yo?",
        "Ano ang pinakamalaking bagay na inaasahan mo?",
        "Ano ang isang bagay na nakakatawa sa'yo?",
        ...
        "Ano ang pinakagusto mong aspeto ng lugar kung saan ka nakatira?",
        "Ano ang isang bagay na nagawa mong hindi mo akalain na magagawa mo?",
        "Sino ang maaari mong laging pagtiwalaan?",
        "Ano ang isang moment sa iyong buhay na alam mong hindi mo makakalimutan?",
        "Ano ang isang bagay na talagang nagpapasalamat ka na subukan?",
        "Ano ang isang paboritong quote na tumatak sa'yo?",
        "Paano mo dinedefine ang kagandahan?",
        "Ano ang isang guilty pleasure na nagpapasaya sa'yo?",
        "Ano ang isang sanhi na pinapahalagahan mo?",
        "Ano ang isang bagay na sana hindi magbago?",
